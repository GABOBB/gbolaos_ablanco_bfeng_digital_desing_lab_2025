module p3 #(parameter N =6) (
    ...
    always_ff @(inicial) begin
        decimal = inicial; // Conversión implícita de binario a decimal
        // Prueba de que se hizo bien la conversión
        $display("Valor de inicial en binario: %b, valor en decimal: %d", inicial, decimal);
    end

    // Separar en dos dígitos de 4 bits
    logic [3:0] unidad, decena;
    assign unidad = decimal % 10;    // Último dígito
    assign decena = decimal / 10;    // Primer dígito
    ...
    function logic [6:0] display7seg(input logic [3:0] num);
        case (num)
            4'd0: display7seg = 7'b1000000;
            4'd1: display7seg = 7'b1111001;
            4'd2: display7seg = 7'b0100100;
            4'd3: display7seg = 7'b0110000;
            4'd4: display7seg = 7'b0011001;
            4'd5: display7seg = 7'b0010010;
            4'd6: display7seg = 7'b0000010;
            4'd7: display7seg = 7'b1111000;
            4'd8: display7seg = 7'b0000000;
            4'd9: display7seg = 7'b0011000;
